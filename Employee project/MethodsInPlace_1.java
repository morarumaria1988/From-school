...
public class MethodsInPlace {
    ...
    // GENERAL MENU
    public void addEmployeebyDepartment() {
    ...
    public void updateEmployees(int id) {
        ...
        if (emp != null) {
            ...
            emp.setAdress(UI.readText());
              ...
              if (emp.getClass().equals(Programmers.class)){
                   System.out.println("Enter The no. of Projects");
                   //create a temp calss so i can use the set ang get 
                   // of the numbers of programs
                   Programmers temp = (Programmers) emp;
                   temp.setNoOfProjects(UI.readNumber());
                                  
              } 
              else
                  if (emp.getClass().equals(SalePeople.class)){
                   System.out.println("Enter The no. of Sales");
                   SalePeople temp = (SalePeople) emp;
                   temp.setNoOfSales(UI.readNumber());
                  }

               //calculate the new bounse
              emp.calculateBonus();
    ...
    public void avrageSalaryForAll() {
        ...
        for (Employee myEmployee : myEmployees) {
          //**** totalSalary = totalSalary+ myEmployee.getSalary();
            totalSalary  += myEmployee.getSalary();
 ...
 */    
        System.out.println("The precentage of Employees for :");
        System.out.println("\n          -Programmers is " + sumprog / sTotal);
        System.out.println("\n          -Sale people is " + sumsale / sTotal);
        System.out.println("\n          -Secretaries is " + sumSec / sTotal);
    }
